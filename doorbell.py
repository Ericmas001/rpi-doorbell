...
# Doorbell
doorbell_notes = [a[z], a[z+1], a[z], s, e[z],
                  e[z+1], e[z], s, c[z], c[z+1], c[z], s]
doorbell_beats = [0.1, 0.25, 0.1, 0.25,
                  0.1, 0.25, 0.1, 0.25, 0.1, 0.25, 0.1, 1]

doorbell2_notes = [a[1+z], s, e[1+z], s, g[1+z], s,
                   c[1+z], s, c[1+z], s, g[1+z], s, a[1+z], s, e[1+z], s]
doorbell2_beats = [0.5, 0.25, 0.5, 0.25, 0.5, 0.25,
                   1, 0.5, 0.5, 0.25, 0.5, 0.25, 0.5, 0.25, 1, 0.5]
...
londonbridges_notes = [g[1+z], a[1+z], g[1+z], f[1+z], e[1+z], f[1+z], g[1+z], d[1+z], e[1+z], f[1+z],
                       e[1+z], f[1+z], g[1+z], g[1+z], a[1+z], g[1 +
                                                                 z], f[1+z], e[1+z], f[1+z], g[1+z],
